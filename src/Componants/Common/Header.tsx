...
const Header = () => {
  ...
  return (
    <div className="fixed z-10 w-full navbar shadow-lg bg-gray-900">
      <div className="flex w-full xl:container xl:m-auto">
        <label
          htmlFor="side-menu"
          className="flex-none lg:hidden btn btn-square btn-ghost sm:w-auto"
        >
          <svg
        ...
        <div className="flex items-center px-2">
          ...
          <a className="btn btn-ghost sm:w-12 ml-1" href="/cart">
            <span className="relative">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 stroke-gray-700 stroke-white"
                fill="none"
                viewBox="0 0 24 24"
              >
                <path
